...
class EM_HomePageViewController: UIViewController, UITableViewDelegate, UINavigationControllerDelegate {
    ...
    let button_blue_s = UIButton()
    let button_green_s = UIButton()
    let button_red_s3 = UIButton()
    let button_red_s4 = UIButton()
    
    var allSupplementalButtons: [UIButton] = []
    ...
    func setUpSupplementalButtons(){
        ...
        button_blue_s.center = CGPoint(x: -view.bounds.width, y: view.bounds.height * 2)
        button_green_s.center = CGPoint(x: -view.bounds.width, y: -view.bounds.height)
        ...
        button_grey_s.alpha = 0
        button_blue_s.alpha = 0
        button_green_s.alpha = 0
        ...
        button_red_s3.center = CGPoint(x: self.view.bounds.width / 2, y: -view.bounds.height)
        button_red_s4.center = CGPoint(x: self.view.bounds.width / 2, y: -view.bounds.height)
        button_red_s3.backgroundColor = Colors.red
        ...
        self.button_red_s3.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
        self.button_red_s4.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
        button_red_s.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
        button_yellow_s.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
        button_grey_s.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
        button_blue_s.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
        button_green_s.addTarget(self, action: "supplementalButtonTapped:", forControlEvents: .TouchUpInside)
    ...
    func bringInSupplementalButtons(supTitles: [String], mainTitles: [String]){
        ...
        func spread(){
            ...
            UIView.animateWithDuration(1, delay: 0, options: [], animations: { () -> Void in
                ...
                self.button_red_s3.frame.origin.x -= self.buttonOriginalWidth! / 2 + extraWidth + 2
                self.button_red_s4.frame.origin.x += self.buttonOriginalWidth! / 2 + 2
                self.button_grey.frame.origin.x -= self.buttonOriginalWidth! / 2 + extraWidth + 2
                self.button_grey_s.frame.origin.x += self.buttonOriginalWidth! / 2 + 2
                self.button_yellow.frame.origin.x -= self.buttonOriginalWidth! / 2 + extraWidth + 2
                self.button_yellow_s.frame.origin.x += self.buttonOriginalWidth! / 2 + 2
                self.button_green.frame.origin.x -= self.buttonOriginalWidth! / 2 + extraWidth + 2
                self.button_green_s.frame.origin.x += self.buttonOriginalWidth! / 2 + 2
                self.button_blue.frame.origin.x -= self.buttonOriginalWidth! / 2 + extraWidth + 2
                self.button_blue_s.frame.origin.x += self.buttonOriginalWidth! / 2 + 2
                
                self.button_red.frame.size.width += extraWidth
                self.button_red_s.frame.size.width += extraWidth
                self.button_red_s3.frame.size.width += extraWidth
                self.button_red_s4.frame.size.width += extraWidth
                self.button_grey.frame.size.width += extraWidth
                self.button_grey_s.frame.size.width += extraWidth
                self.button_yellow.frame.size.width += extraWidth
                self.button_yellow_s.frame.size.width += extraWidth
                self.button_green.frame.size.width += extraWidth
                self.button_green_s.frame.size.width += extraWidth
                self.button_blue.frame.size.width += extraWidth
...
//                    self.view.bringSubviewToFront(self.undoButton)
        ...
        func stack(){
            UIView.animateWithDuration(1, delay: 0, options: [], animations: { () -> Void in
                self.button_red.frame.origin.y = yOffset
                self.button_red_s.frame.origin.y = yOffset
            ...
            UIView.animateWithDuration(1, delay: 0.6, options: [], animations: { () -> Void in
                self.button_yellow.frame.origin.y = yOffset
        ...
        for button in all{
            UIView.animateWithDuration(1, delay: 0, options: [], animations: { () -> Void in
                button.frame.size = CGSize(width: self.buttonOriginalWidth!, height: self.buttonOriginalHeight!)
                button.frame.size.height = buttonHeight * multiplier
   ...
   // layer1.addAnimation(animationMoveY, forKey: "move")
    ...
    func animateIntroButtons(){
        ...
        func animationPart6(){
            ...
            let position1 = self.button_grey.frame
            let position2 = self.button_blue.frame
            let position3 = self.button_red.frame
            let position4 = self.button_green.frame
            
            UIView.animateWithDuration(0.5, delay: 0.1, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .CurveEaseInOut, animations: { () -> Void in
                self.button_red.frame = position1
                }, completion: nil)
            UIView.animateWithDuration(0.5, delay: 0.1, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .CurveEaseInOut, animations: { () -> Void in
                self.button_grey.frame = position2
                }, completion: nil)
            UIView.animateWithDuration(0.5, delay: 0.1, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .CurveEaseInOut, animations: { () -> Void in
                self.button_green.frame = position3
                }, completion: nil)
            UIView.animateWithDuration(0.5, delay: 0.1, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .CurveEaseInOut, animations: { () -> Void in
                
                }, completion: nil)
            UIView.animateWithDuration(0.5, delay: 0.2, usingSpringWithDamping: 0.7, initialSpringVelocity: 1, options: .CurveEaseInOut, animations: { () -> Void in
                self.button_blue.frame = position4
                }, completion: { _ in
        ...
        func animationPart3(){
                ...
                UIView.animateWithDuration(0.5, delay: 0, options: .CurveEaseInOut, animations: { () -> Void in
                    self.button_red.frame.origin.y += 2.5
                    self.button_blue.frame.origin.y -= 2.5
                    self.button_green.frame.origin.x -= 2.5
                    self.button_grey.frame.origin.x += 2.5
        ...
        func animationPart2(){
            for button in allButtons {
                UIView.animateWithDuration(0.5, delay: 0, options: .CurveEaseInOut, animations: { () -> Void in
                    ...
                    button.center = CGPoint(x: 8 * w, y: 2/3 * self.view.bounds.size.height)
                    
                    }, completion: { _ in
                        self.view.bringSubviewToFront(self.button_yellow)
                        animationPart3()
        ...
        //self.rotateBy(button)
        button.alpha = 0
        button.layer.cornerRadius = 15
        button.center = CGPoint(x: 14 * w, y: -20)
        button.frame.size = CGSize(width: w * 2, height: w * 2)
        ...
        for button in allButtons {
            ...
            UIView.animateWithDuration(1, delay: 0, options: .CurveEaseInOut, animations: { () -> Void in
                button.alpha = 1
                button.center = CGPoint(x: 14 * w, y: 2/3 * self.view.bounds.size.height)
    ...
    func moveButtonsByCurve(){
        ...
        for button in allButtons{
            ...
            path.addCurveToPoint(CGPoint(x: 301 * i, y: 239), controlPoint1: CGPoint(x: 136, y: 373), controlPoint2: CGPoint(x: 178, y: 110))
    ...
    func moveButtonsByRandomCurve(){
        ...
        for button in allButtons{
            ...
            path.addCurveToPoint(CGPoint(x: 400, y: 239 + randomYOffset), controlPoint1: CGPoint(x: 136, y: 373 + randomYOffset), controlPoint2: CGPoint(x: 178, y: 110 + randomYOffset))
            // create a new CAKeyframeAnimation that animates the objects position
            let anim = CAKeyframeAnimation(keyPath: "position")
    ...
    func expandAsStackRemedies(){
     
        let buttons = [self.button_blue, self.button_grey, self.button_yellow, self.button_green, self.button_red]
        var delay = 0.1
        var offSetY = CGFloat(5)
        for button in buttons{
            UIView.animateWithDuration(0.5, delay: delay, options: .CurveEaseInOut, animations: { () -> Void in
    ...
    func moveButtonsLikeCross(){
        ...
        UIView.animateWithDuration(1, delay: 0.0, usingSpringWithDamping: 0.8, initialSpringVelocity: 1, options: [.CurveEaseInOut], animations: { () -> Void in
            ...
            self.button_red.frame.size = CGSize(width: w * 2, height: w * 2)
            self.button_red.center = CGPoint(x: w * 4, y: h * 1.5)
            self.button_red.layer.cornerRadius = cornerRadius
            self.button_red.alpha = 1
            }, completion: {_ in
                UIView.animateWithDuration(0.5, animations: { () -> Void in
                    self.button_red.alpha = 1
        ...
        UIView.animateWithDuration(1, delay: 0.1, usingSpringWithDamping: 0.8, initialSpringVelocity: 1, options: [.CurveEaseInOut], animations: {
            
            self.button_yellow.frame.size = CGSize(width: w * 2, height: w * 2)
            self.button_yellow.center = CGPoint(x: w * 4, y: h * 4)
            self.button_yellow.layer.cornerRadius = cornerRadius
            self.button_yellow.alpha = 1
        ...
        UIView.animateWithDuration(1, delay: 0.1, usingSpringWithDamping: 0.8, initialSpringVelocity: 1,
            options: [.CurveEaseInOut], animations: {
                ...
                self.button_green.layer.cornerRadius = cornerRadius
                self.button_green.alpha = 1
            }, completion: {_ in
                UIView.animateWithDuration(0.5, animations: { () -> Void in
                    self.button_green.alpha = 1
        ...
        UIView.animateWithDuration(1, delay: 0.2, usingSpringWithDamping: 0.8, initialSpringVelocity: 1,
            options: [.CurveEaseInOut], animations: {
                ...
                self.button_grey.layer.cornerRadius = cornerRadius
                self.button_grey.alpha = 1
            }, completion: {_ in
                UIView.animateWithDuration(0.5, animations: { () -> Void in
                    self.button_grey.alpha = 1
        ...
        UIView.animateWithDuration(1, delay: 0.2, usingSpringWithDamping: 0.8, initialSpringVelocity: 1,
            options: [.CurveEaseInOut], animations: {
                ...
                self.button_blue.layer.cornerRadius = cornerRadius
                self.button_blue.alpha = 1
